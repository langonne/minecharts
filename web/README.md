...
### OAuth / OIDC login buttons

The login page queries `/api/auth/providers` and renders a button for each provider the API reports as configured. No build-time flags are needed on the frontend.
