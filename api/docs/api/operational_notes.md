...
- The `/servers/{serverName}/expose` endpoint deletes any existing service for the StatefulSet before creating a new one, preventing stale exposure modes from lingering.
